<?php /* Smarty version 2.6.19, created on 2011-04-14 09:10:30
         compiled from admin_image.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin_image.htm', 100, false),)), $this); ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'libs/image_info.htm', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php else: ?>
<div class="main-div">
 ...
 &raquo; <?php echo $this->_tpl_vars['lang']['image_manage']; ?>
...
')" onmouseup="this.className='btn btn-hover'" onmousedown="this.className='btn btn-active'" onmouseover="this.className='btn btn-hover'" onmouseout="this.className='btn btn-dft'" tabindex="0"><span><?php echo $this->_tpl_vars['lang']['image_restore']; ?>
</span></span>
		<?php else: ?>
...
')">　&raquo;<?php echo $this->_tpl_vars['menu']['name']; ?>
		   ...
		   <span class="btnM" onclick="ShowSubMenu(this)" onmouseup="this.className='btnM-hover'" onmousedown="this.className='btnM-active'" onmouseout="this.className='btnM'" onmouseover="this.className='btnM-hover'" tabindex="0"><?php echo $this->_tpl_vars['lang']['view']; ?>
			...
			<ul class="submenu" onmouseover="ShowMenu(this)" onmouseout="HideMenu(this)">
				 ...
				 <li><a href="javascript:;" onclick="ListTable('&t=recommend')"><?php echo $this->_tpl_vars['lang']['image_commend']; ?>
</a></li>
				 <li onmouseover="ShowSubMenu(this)" onmouseout="HideSubMenu(this)"><a href="javascript:;"><?php echo $this->_tpl_vars['lang']['image_cat']; ?>
<b class="arr2"></b></a>
				     <ul>
						 <?php $_from = $this->_tpl_vars['category']['0']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['group']):
...
"><?php echo $this->_tpl_vars['lang']['image_title']; ?>
</th>
...
" onclick="checkThis(this)" /></td>
		<td style="text-align:center;"><a href="<?php echo $this->_tpl_vars['img']['imgurl']; ?>
...
?action=edit&id=<?php echo $this->_tpl_vars['img']['id']; ?>
...
" onclick="window.open('admin_image_file.php?action=add&gid=<?php echo $this->_tpl_vars['img']['id']; ?>
')"></b>
		  </span>
		</td>
		<td style="text-align:center;"><?php echo $this->_tpl_vars['img']['comments']; ?>
</td>
		<td style="text-align:center;"><img src="<?php if ($this->_tpl_vars['img']['audited'] == 1): ?>images/yes.gif<?php else: ?>images/no.gif<?php endif; ?>" title="<?php echo $this->_tpl_vars['lang']['click_switch']; ?>
" onclick="toggle(this,'toggle_audited',<?php echo $this->_tpl_vars['img']['id']; ?>
);" /></td>
		<td style="text-align:center;"><img src="<?php if ($this->_tpl_vars['img']['recommend'] == 1): ?>images/yes.gif<?php else: ?>images/no.gif<?php endif; ?>" title="<?php echo $this->_tpl_vars['lang']['click_switch']; ?>
" onclick="toggle(this,'toggle_recommend',<?php echo $this->_tpl_vars['img']['id']; ?>
);" /></td>
        <td style="text-align:center;"><?php echo $this->_tpl_vars['img']['views']; ?>
</td>
