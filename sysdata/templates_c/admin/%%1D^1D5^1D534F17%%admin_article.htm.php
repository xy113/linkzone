<?php /* Smarty version 2.6.19, created on 2011-04-14 08:18:43
         compiled from admin_article.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin_article.htm', 97, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'page_header.htm', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<div id="msg" class="msg_r"></div>
<?php if ($this->_tpl_vars['action'] == 'addnew' || $this->_tpl_vars['action'] == 'edit'): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'libs/article_info.htm', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php else: ?>
<div class="main-div">
 ...
 &raquo; <?php echo $this->_tpl_vars['lang']['article_manage']; ?>
...
')" onmouseover="this.className='btn btn-hover'" onmouseup="this.className='btn btn-hover'" onmousedown="this.className='btn btn-active'" onmouseout="this.className='btn btn-dft'" tabindex="0"><span><?php echo $this->_tpl_vars['lang']['restore_article']; ?>
</span></span>
		<?php else: ?>
...
?action=addnew&cid=<?php echo $_GET['cid']; ?>
')" onmouseover="this.className='btn btn-hover'" onmouseup="this.className='btn btn-hover'" onmousedown="this.className='btn btn-active'" onmouseout="this.className='btn btn-dft'" tabindex="0"><span><?php echo $this->_tpl_vars['lang']['addnew_article']; ?>
</span></span>
...
&<?php echo $this->_tpl_vars['curl']; ?>
')"><?php echo $this->_tpl_vars['lang']['recommend_article']; ?>
</a></li>
...
')">　&raquo;<?php echo $this->_tpl_vars['menu']['name']; ?>
		   ...
		   <span class="btnM" onclick="ShowSubMenu(this)" onmouseup="this.className='btnM-hover'" onmousedown="this.className='btnM-active'" onmouseout="this.className='btnM'" onmouseover="this.className='btnM-hover'" tabindex="0"><?php echo $this->_tpl_vars['lang']['view']; ?>
			...
			<ul class="submenu" onmouseover="ShowMenu(this)" onmouseout="HideMenu(this)">
				 ...
				 <li><a href="javascript:;" onclick="ListTable('&t=all')"><?php echo $this->_tpl_vars['lang']['all_article']; ?>
</a></li>
				 <li><a href="javascript:;" onclick="ListTable('&t=recommend')"><?php echo $this->_tpl_vars['lang']['recommend_article']; ?>
</a></li>
				 <li><a href="javascript:;" onclick="ListTable('&t=img')"><?php echo $this->_tpl_vars['lang']['image_article']; ?>
</a></li>
				 <li onmouseover="ShowSubMenu(this)" onmouseout="HideSubMenu(this)"><a href="javascript:;"><?php echo $this->_tpl_vars['lang']['article_cat']; ?>
<b class="arr2"></b></a>
				     <ul>
						 <?php $_from = $this->_tpl_vars['category']['0']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['group']):
...
"><?php echo $this->_tpl_vars['lang']['article_title']; ?>
</th>
...
" onclick="checkThis(this)" /></td>
			<td style="text-align:center;"><a href="<?php echo $this->_tpl_vars['arc']['arcurl']; ?>
" target="_blank"><img src="images/icon_view.gif" title="<?php echo $this->_tpl_vars['lang']['view']; ?>
" border="0" /></a></td>
			<td><a href="admin_article.php?action=edit&id=<?php echo $this->_tpl_vars['arc']['id']; ?>
"><?php echo $this->_tpl_vars['arc']['title']; ?>
</a></td>
			<td style="text-align:center;"><?php echo $this->_tpl_vars['arc']['comments']; ?>
</td>
			<td style="text-align:center;"><img onclick="toggle(this,'toggle_audited',<?php echo $this->_tpl_vars['arc']['id']; ?>
)" title="<?php echo $this->_tpl_vars['lang']['click_switch']; ?>
" src="<?php if ($this->_tpl_vars['arc']['audited'] == 1): ?>images/yes.gif<?php else: ?>images/no.gif<?php endif; ?>" border="0" /></td>
			<td style="text-align:center;"><img onclick="toggle(this,'toggle_recommend',<?php echo $this->_tpl_vars['arc']['id']; ?>
)" title="<?php echo $this->_tpl_vars['lang']['click_switch']; ?>
" src="<?php if ($this->_tpl_vars['arc']['recommend'] == 1): ?>images/yes.gif<?php else: ?>images/no.gif<?php endif; ?>" border="0" /></td>
			<td style="text-align:center;"><?php echo $this->_tpl_vars['arc']['views']; ?>
</td>
